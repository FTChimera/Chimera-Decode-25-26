...
public class Consts {
    public static double TARGET_VELOCITY_BACK_LAUNCH_ZONE = 1670;// Set target velocity from back launch zone
    public static double TARGET_VELOCITY_FRONT_LAUNCH_ZONE = 1200;// Set target velocity from front launch zone
