...
public class RED_AUTO extends OpMode {
    ...
    private final Pose empty_gate_0ControlPoint1 = new Pose(
            110,
            72,
            0
    );

    private final Pose empty_gate_0ControlPoint2 = new Pose(
            120,
            72,
            0
    );
